...
const Donation = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await api.post("/donate", { amount });
      ...
      <div className="w-full max-w-md rounded-xl shadow-xl overflow-hidden border-2 border-gray-100">
        <div className="relative">
          ...
          <div className="text-center p-8 relative">
            ...
            <h2 className="text-3xl font-bold text-white font-head">
              Support Us
            </h2>
            <p className="text-white font-para mt-2 max-w-xs mx-auto">
              Your contribution helps us protect wildlife and preserve their
        ...
        <div className="p-6 md:p-8">
          ...
          <div className="mt-8 pt-6 border-t border-gray-100">
            <div className="flex items-center justify-center space-x-2 mb-4">
              ...
              <span className="text-md text-white font-medium font-para">
                Secure Payment
              </span>
            </div>
            <div className="text-center text-xs text-white font-para">
              <p>
                Donations are tax-deductible under Section 80G of Income Tax
                Act.
              </p>
