  ...
  return (
    <div className="max-w-xl mx-auto  p-8 rounded-xl shadow-lg border border-green-100 mt-28 mb-5">
      ...
      {status?.type === "error" && (
        <div
          data-aos="zoom-in"
          className="mb-4 flex w-full overflow-hidden bg-red-700 rounded-lg text-lg"
        >
          <div className="flex items-center justify-center w-12 bg-white">
      ...
      <div className="mb-6 text-center">
        ...
        <p className="text-white">
          Reserve your spot for an unforgettable wildlife experience!
        </p>
      </div>
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className=" p-6 rounded-lg shadow-sm">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label
                htmlFor="name"
                className="block text-customLightOrange font-medium mb-2"
              >
        ...
        <div className="p-5 bg-amber-50 rounded-lg border-l-4 border-[#e9d502] shadow-sm">
          ...
          <p className="text-amber-700 text-sm">
            This form is for registration purposes only. After submission, you
            will receive an email with payment instructions and additional
            details about your zoo adventure.
          </p>
        </div>
