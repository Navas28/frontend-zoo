...
const Booking = () => {
  const buyFunction = async (bookingType) => {
    let response = await api.post("/ticketbooking/payment", { bookingType });
      ...
      <div className="sm:flex sm:flex-col sm:align-center p-10">
        <div className="mt-12 space-y-3 sm:mt-16 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-6 md:max-w-[1600px] md:mx-auto xl:grid-cols-4">
          <div className="bg-white rounded-xl hover:scale-102 duration-500 ease-in-out">
            <div className="p-6">
              <h2 className="text-xl sm:text-3xl  leading-6 font-bold text-customMediumGreen font-subhead">
                Standard
              </h2>
              <p className="mt-4">
                <span className="text-4xl font-bold text-customMediumGreen tracking-tighter">
                  &#8377; 200
                </span>
            ...
            <div className="pb-8 px-6">
              ...
              <p className="mt-4 text-sm leading-tight font-para">
                <span className="text-xl text-red-600">*</span> Special Offers
                for Students & Individuals with Disabilities!
              </p>
            </div>
          </div>
